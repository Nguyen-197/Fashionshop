...
export const MenuPrivateRouteComponent = ({
    ...
    }, [listMenuItem, pathname]);

    const checkAuthorities = props =>
        isAuthorized ? (
            <ErrorBoundary>
                <div className={`wrap-content ${expand ? "" : "sidebar-left-mini "}wrap-container`}>
                ...
                <>
                    <div className="insufficient-authority m-auto">
                        <div className="alert alert-danger text-center">
                            <h1>403</h1>
                            <h5>Forbidden</h5>
                            <Translate contentKey="Bạn không được cấp quyền xem mục này">You are not authorized to access this page.</Translate>
                            <br/>
...
const mapStateToProps = (
    { authentication: { isAuthenticated, account, isSessionHasBeenFetched, menu, listMenuItem }, menuLeft }: IRootState,
