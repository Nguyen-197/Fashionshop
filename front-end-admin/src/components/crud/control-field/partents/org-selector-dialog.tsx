...
type IOrgSelectorDialogProps = StateProps & DispatchProps & {
    onSelected?: (org) => void;
}

const OrgSelectorDialog = (props: IOrgSelectorDialogProps) => {
    ...
    useEffect(() => {
        const loadDatasource = async () => {
            await OrganizationService.initTreeOrg().then((res: any) => {
    ...
    const doSearch = async (event?) => {
        ...
        await OrganizationService.search(formData, event).then((res: any) => {
    ...
    const loadOnExpand = async (event: any) => {
        if (!event.node.children) {
            ...
            await OrganizationService.lazyLoadTree(formData).then((res: any) => {
